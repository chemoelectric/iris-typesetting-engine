...
package bits_pthreadtypes_h is
   ...
   subtype anon_array1230 is Interfaces.C.char_array (0 .. 3);
   type pthread_mutexattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1230;  -- /usr/local/include/bits/pthreadtypes.h:34
         when others =>
   ...
   type pthread_condattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1230;  -- /usr/local/include/bits/pthreadtypes.h:43
         when others =>
   ...
   subtype anon_array1238 is Interfaces.C.char_array (0 .. 55);
   type pthread_attr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1238;  -- /usr/local/include/bits/pthreadtypes.h:58
         when others =>
   ...
   subtype anon_array1242 is Interfaces.C.char_array (0 .. 39);
   type pthread_mutex_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased anon_array1242;  -- /usr/local/include/bits/pthreadtypes.h:70
         when others =>
   ...
   subtype anon_array1246 is Interfaces.C.char_array (0 .. 47);
   type pthread_cond_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased anon_array1246;  -- /usr/local/include/bits/pthreadtypes.h:78
         when others =>
   ...
   type pthread_rwlock_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased anon_array1238;  -- /usr/local/include/bits/pthreadtypes.h:89
         when others =>
   ...
   subtype anon_array1252 is Interfaces.C.char_array (0 .. 7);
   type pthread_rwlockattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1252;  -- /usr/local/include/bits/pthreadtypes.h:95
         when others =>
   ...
   subtype anon_array1258 is Interfaces.C.char_array (0 .. 31);
   type pthread_barrier_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1258;  -- /usr/local/include/bits/pthreadtypes.h:110
         when others =>
   ...
   type pthread_barrierattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon_array1230;  -- /usr/local/include/bits/pthreadtypes.h:116
         when others =>
