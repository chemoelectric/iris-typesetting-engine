...
package bits_thread_shared_types_h is
   ...
   type anon_array1259 is array (0 .. 1) of aliased unsigned;
   type uu_pthread_cond_s is record
      ...
      uu_g_size : aliased anon_array1259;  -- /usr/local/include/bits/thread-shared-types.h:98
      ...
      uu_g_signals : aliased anon_array1259;  -- /usr/local/include/bits/thread-shared-types.h:101
